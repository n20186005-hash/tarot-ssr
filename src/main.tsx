...
class ErrorBoundary extends React.Component<{children: React.ReactNode}, {hasError: boolean, error: any}> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="p-8 text-white bg-red-900 min-h-screen flex flex-col items-center justify-center">
...
const Globe = (props: any) => (
  <IconWrapper {...props}><circle cx="12" cy="12" r="10"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/><path d="M2 12h20"/></IconWrapper>
);
const ArrowRight = (props: any) => (
  <IconWrapper {...props}><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></IconWrapper>
);
const Sparkles = (props: any) => (
  <IconWrapper {...props}><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L12 3Z"/><path d="M5 3v4"/><path d="M9 5H3"/><path d="M5 16v4"/><path d="M3 18h6"/><path d="M16 19h6"/><path d="M19 16v6"/></IconWrapper>
);
const Layers = (props: any) => (
  <IconWrapper {...props}><path d="m12.83 2.12-7.55 3.23a1.5 1.5 0 0 0 0 2.76l7.55 3.23a1.5 1.5 0 0 0 1.17 0l7.55-3.23a1.5 1.5 0 0 0 0-2.76l-7.55-3.23a1.5 1.5 0 0 0-1.17 0z"/><path d="M22 12L12 17L2 12"/><path d="M22 17L12 22L2 17"/></IconWrapper>
);
...
const Heart = (props: any) => (
  <IconWrapper {...props}><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></IconWrapper>
);
